...
from aap_gateway_api.common.envoy import DOWNSTREAM_TLS_CONTEXT, EXT_AUTHZ_FILTER, HTTP_CONNECTION_MANAGER, HTTP_ROUTER, LUA_FILTER, STDOUT_ACCESS_LOG, TYPE_KEY
...
def http_router_filter():
    return {"name": "envoy.filters.http.router", "typed_config": {TYPE_KEY: HTTP_ROUTER}}
...
def network_manager_filter(http_filters=[], routes=[]):
    return {
        ...
        "typed_config": {
            TYPE_KEY: HTTP_CONNECTION_MANAGER,
            ...
            "access_log": [
                {
                    ...
                    "typed_config": {TYPE_KEY: STDOUT_ACCESS_LOG},
                },
            ],
...
def transport_socket():
    return {
        ...
        "typed_config": {
            TYPE_KEY: DOWNSTREAM_TLS_CONTEXT,
