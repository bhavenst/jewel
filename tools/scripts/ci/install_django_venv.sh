...
#
# Usage: install_django_venv.sh <envdir> <pip_opts> <packages>

# Exit on any error
set -e

# Pass in the tox env directory as the first argument ({envdir})
ENV_DIR="$1"
...
./tools/scripts/ci/tox-reinstall-django-ansible-base.sh "$ENV_DIR"
